...
fun main() {
    ...
    repeat(10) {
        ...
        elves.forEach { coord ->
            val firstCheck = checks[it.mod(4)](elves, coord)
            val secondCheck = checks[(it + 1).mod(4)](elves, coord)
            val thirdCheck = checks[(it + 2).mod(4)](elves, coord)
            val fourthCheck = checks[(it + 3).mod(4)](elves, coord)
            val nextCoord =
